                ...
                <div id="projects-panel" class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <button id="new_project" class="btn btn-default pull-right" onclick="goto_create(<?=$project_category['pc_id'];?>)">
...
<script>
    ...
    function goto_create(pc_id)
    {
        location.href = '<?=site_url('admin/project/create');?>' + '/' + pc_id;
    }
</script>
</body>
</html>
