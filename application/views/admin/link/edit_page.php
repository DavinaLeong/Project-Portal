                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control" id="lc_id" name="lc_id" required>
                                            ...
                                            <?php foreach($link_categories as $key=> $link_category): ?>
                                                <option id="lc_id_<?=$key+1;?>" value="<?=$link_category['lc_id'];?>" <?=set_select('lc_id', $link_category['lc_id'], ($link['lc_id'] == $link['lc_id']));?>><?=$link_category['platform_name'] . ', ' . $link_category['project_name'];?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
