    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div id="main" class="col-lg-12">
                <h1 class="page-header text-info"><i class="fas fa-eye fa-fw"></i> View Link&nbsp;
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a id="edit_record" href="<?=site_url('admin/link/edit/' . $link['link_id']);?>"><i class="fas fa-edit fa-fw"></i> Edit Record</a></li>
