    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div id="main" class="col-lg-12">
                <h1 class="page-header text-info"><i class="fa fa-plus fa-fw"></i> Create Project</h1>
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control" id="pc_id" name="pc_id" required>
                                            ...
                                            <?php foreach($project_categories as $key=> $project_category): ?>
                                                <option id="pc_id_<?=$key+1;?>" value="<?=$project_category['pc_id'];?>" <?=set_select('pc_id', $project_category['pc_id'], ($project_category['pc_id'] == $pc_id));?>><?=$project_category['pc_name'];?> (<?=$project_category['platform_name'];?>)</option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" id="project_name" name="project_name"
                                               value="<?=set_value('project_name');?>" required maxlength="512" />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control" id="project_status" name="project_status" required>
                                            ...
                                            <?php foreach($status_options as $key=>$status_option): ?>
                                                <option id="project_status_<?=$key+1;?>" value="<?=$status_option;?>" <?=set_select("project_status", $status_option);?>><?=$status_option;?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
